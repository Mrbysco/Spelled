...
public class SpelledDataGen {
    ...
    private static class Language extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            add("info.spelled.book.types.self.text", "Using \"sui\" or \"sese\" you can apply the spell to yourself");
            add("info.spelled.book.types.ball.name", "Ball");
            add("info.spelled.book.types.ball.text", "Not a square? WOW...");
            ...
            add("info.spelled.book.size.desc", "Whoever said size doesn’t matter lied. Size does matter, especially when you trying to throw a fireball at your enemy! The first recorded use of this spell seems to have come when a shaman was trying to grow his crops quicker. A mispronunciation meant that instead of accelerate, the world large was uttered, and what was an ordinary carrot was transformed into a man sized carrot. Experimentation was done and soon various words that can alter size were discovered.");
            add("info.spelled.book.size.parvus.name", "Parvus");
            add("info.spelled.book.size.parvus.text", "Insert 50 word lore about the size keyword!");
            add("info.spelled.book.size.magnum.name", "Magnum");
            add("info.spelled.book.size.magnum.text", "Insert 50 word lore about the size keyword!");
            add("info.spelled.book.size.grandis.name", "Grandis");
            add("info.spelled.book.size.grandis.text", "Insert 50 word lore about the size keyword!");
            add("info.spelled.book.size.immanis.name", "Immanis");
            add("info.spelled.book.size.immanis.text", "Insert 50 word lore about the size keyword!");
            ...
            add("info.spelled.book.descriptive.liquidus.text", "Insert 50 word lore about the descriptive keyword!");
            add("info.spelled.book.descriptive.liquidus.text2", "Insert 50 word lore about the descriptive keyword!");
            ...
            add("info.spelled.book.descriptive.frigus.text2", "");
            ...
            add("info.spelled.book.descriptive.fractionis.text", "Can’t make an omelette without breaking some eggs, and the same goes for magic. This spell lets you break through walls like a hypothetical automorphic jar filled with flavoured water, while still looking awesome! Unusually this spell was not discovered by a word wielder, but by an angry shop keeper. A clumsy client was less than careful in a glass blowers shop,");
