...
public class LootHelper {
	...
	public static LootContext.Builder silkContextBuilder(ServerLevel level, BlockPos pos, SpellEntity spell) {
		ItemStack dummy = getDummyTool();
		dummy.enchant(Enchantments.SILK_TOUCH, 1);

		return new LootContext.Builder(level).withRandom(level.random)
