...
import com.mrbysco.spelled.client.gui.state.AltarBookModelRenderer;
...
public class ClientHandler {
	...
	@SubscribeEvent
	public static void registerPictureInPicture(RegisterPictureInPictureRenderersEvent event) {
		event.register(AltarBookRenderState.class, AltarBookModelRenderer::new);
	}
}
