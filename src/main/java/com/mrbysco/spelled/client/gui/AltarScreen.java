...
public class AltarScreen extends ContainerScreen<AltarContainer> {
    ...
    protected void renderBg(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        boolean flag = true;
        if(player != null) {
            flag = levelCost > 0 && ((itemFlag || player.experienceLevel < levelCost) && !player.abilities.instabuild);
        }
        ...
        int j2;
        if (player != null && ((itemFlag || player.experienceLevel < levelCost) && !player.abilities.instabuild)) {
            j2 = 4226832;
        } else {
            j2 = 8453920;
        }
