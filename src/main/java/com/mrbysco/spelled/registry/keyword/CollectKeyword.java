...
public class CollectKeyword extends BaseKeyword {
    public static final String ACTION_NAME = "collect";

	public CollectKeyword(String keyword, int level, int slots) {
	...
	public void cast(Level level, ServerPlayer caster, SpellEntity spell, @Nullable IKeyword adjective) {
		if (spell != null) {
			spell.insertAction(ACTION_NAME);
            spell.setCollecting(true);
		}
	}
}
